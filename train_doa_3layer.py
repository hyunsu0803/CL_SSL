...
class Trainer():
    ...
    def train(self, epoch):
        ...
        for iter_num, (mixed, vad, speech_azi, white_snr, coherent_snr, rt60) in enumerate(tqdm(self.dataloader.train_loader, desc='Train {}'.format(epoch), total=len(self.dataloader.train_loader), )):
            ...
            self.learner.memory_delete([mixed, vad, speech_azi, white_snr, coherent_snr, rt60, out, loss, target])
            gc.collect()
